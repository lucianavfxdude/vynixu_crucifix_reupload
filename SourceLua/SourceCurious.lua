...
local assets = {
    Repentance = LoadCustomInstance("https://github.com/lucianavfxdude/curiouscrucifix_byvynixu/blob/main/CuriousRepentance.rbxm?raw=true"),
    Crucifix = LoadCustomInstance("https://github.com/lucianavfxdude/curiouscrucifix_byvynixu/raw/refs/heads/main/ogcrucifix.rbxm")
}
local moduleScripts = {
